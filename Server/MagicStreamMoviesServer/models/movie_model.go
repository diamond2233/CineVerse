...
type Movie struct {
	...
	Genre        []Genre       `bson:"genre" json:"genre" validate:"required,dive"` // dive keyword ensures that nested structure which is an arary for genres is also validated
	AdminrReview string        `bson:"admin_review" json:"admin_review"`
